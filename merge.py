...
def parse_arguments():
    ...
    parser.add_argument('-d', '--dirs', nargs='+', required=True, help="List of VCF files")
    parser.add_argument('-x', '--wait',nargs='+', required=True, help="wait")

    return parser.parse_args()

def process_vcf_files(directory_path, reference, wait):
...
if __name__ == "__main__":
    ...
    for directory in dirs:
        process_vcf_files(directory, reference_file, waiting)
